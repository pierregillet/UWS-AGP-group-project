...
//    glUniform1f(uniformIndex, Constants::LightAttenuation::constant);
//    uniformIndex = glGetUniformLocation(program, "attLinear");
//    glUniform1f(uniformIndex, Constants::LightAttenuation::linear);
//    uniformIndex = glGetUniformLocation(program, "attQuadratic");
//    glUniform1f(uniformIndex, Constants::LightAttenuation::quadratic);
//    return program;
//}
